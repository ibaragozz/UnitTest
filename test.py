...
class TestHW(unittest.TestCase):
    def test_hw_success(self):
        self.assertEqual(hw(100, 5), 0)
        self.assertEqual(hw(200, 5), 0)
        self.assertNotEqual(hw(21, 7), 5)

    def test_hw_by_zero(self):
        self.assertRaises(ValueError, hw, 10, 0)
